...
public class AppUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    final private String MSG_TOKEN_NAO_INFORMADO = "Token de autorização não enviado";
    final private String MSG_AUTHORIZATION_HEADER_INCORRETO = "Header do token de autorização esta incorreto ou inexistente";
